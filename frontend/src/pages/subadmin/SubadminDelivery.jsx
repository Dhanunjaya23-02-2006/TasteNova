...
const SubadminDelivery = () => {
    ...
    const fetch_ = async () => {
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/subadmin/delivery${q}`, { headers: { Authorization: `Bearer ${user.token}` } });
    ...
    const handleStatus = async (id, status) => {
        try {
            const res = await fetch(`${API_URL}/subadmin/delivery/${id}/status`, {
...
export default SubadminDelivery;
