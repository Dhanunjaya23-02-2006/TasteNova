...
const SubadminCoupons = () => {
    ...
    const fetchCoupons = async () => {
        try {
            const res = await fetch(`${API_URL}/subadmin/coupons`, { headers: { Authorization: `Bearer ${user.token}` } });
    ...
    const handleCreate = async (e) => {
        e.preventDefault();
        try {
            const res = await fetch(`${API_URL}/subadmin/coupons`, {
    ...
    const toggleActive = async (id, isActive) => {
        try {
            await fetch(`${API_URL}/subadmin/coupons/${id}`, {
...
export default SubadminCoupons;
