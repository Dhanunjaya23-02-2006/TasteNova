...
const SubadminRefunds = () => {
    ...
    const fetchRefunds = async () => {
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/subadmin/refunds${q}`, { headers: { Authorization: `Bearer ${user.token}` } });
    ...
    const handleRefund = async (id, action) => {
        ...
        try {
            const res = await fetch(`${API_URL}/subadmin/refunds/${id}`, {
...
export default SubadminRefunds;
