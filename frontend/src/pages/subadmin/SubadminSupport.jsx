...
const SubadminSupport = () => {
    ...
    const fetchTickets = async () => {
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/subadmin/support${q}`, { headers: { Authorization: `Bearer ${user.token}` } });
            if (res.ok) {
    ...
    const handleUpdate = async (id, status, resolution) => {
        try {
            ...
            const res = await fetch(`${API_URL}/subadmin/support/${id}`, {
...
export default SubadminSupport;
