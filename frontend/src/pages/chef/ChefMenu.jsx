                            ...
                            <div className="food-card-content">
                                ...
                                <div className="food-footer">
                                    ...
                                    {cartItems.find(i => i._id === item._id) ? (
                                        <div className="btn-add" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '4px 8px', background: 'var(--primary)', color: '#fff', minWidth: '80px', border: '1px solid var(--primary)' }}>
                                            <button onClick={(e) => { e.stopPropagation(); updateQuantity(item._id, -1); }} style={{ background: 'none', border: 'none', color: '#fff', fontSize: '1.2rem', cursor: 'pointer', padding: '0 8px' }}>-</button>
                                            <span style={{ color: '#fff', fontWeight: 'bold' }}>{cartItems.find(i => i._id === item._id).qty}</span>
                                            <button onClick={(e) => { e.stopPropagation(); updateQuantity(item._id, 1); }} style={{ background: 'none', border: 'none', color: '#fff', fontSize: '1.2rem', cursor: 'pointer', padding: '0 8px' }}>+</button>
                                        </div>
                                    ) : (
                                        <button 
